  ...
  <nav class="bg-gradient-to-r from-blue-600 to-blue-700 text-white shadow-lg sticky top-0 z-40">
    <div class="container mx-auto px-4 py-3 flex items-center justify-between max-w-5xl">
      ...
      <div class="flex items-center space-x-3">
        <button
          @click="goToTutorial"
          class="bg-white/20 hover:bg-white/30 text-white font-medium px-4 py-2 rounded-lg transition duration-150 ease-in-out text-sm flex items-center space-x-2"
          title="查看使用教程"
        >
